...
(note: SIGIL requires OpenGL.  It did not work on an older laptop with integrated graphics
however, it worked fine on a desktop PC with a dedicated graphics card.)
